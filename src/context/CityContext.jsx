...
const CityStatueContext = createContext([]);
...
const cities =[
  ...
  return (
    <CityStatueContext.Provider value={cities}>
      {cities}
    </CityStatueContext.Provider>
  );
}
